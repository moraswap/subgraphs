...
export class MoraToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class MoraToken extends ethereum.SmartContract {
  static bind(address: Address): MoraToken {
    return new MoraToken("MoraToken", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): MoraToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new MoraToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<MoraToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new MoraToken__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
